    ...
    <div class="slms-main flex-1 flex flex-col min-w-0">
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <button id="teacherNotificationToggle" type="button" class="h-10 w-10 rounded-full bg-white text-gray-600 border border-gray-200 flex items-center justify-center hover:bg-gray-50 relative" aria-label="Notifications">
                        ...
                        <div id="teacherNotificationPanel" class="hidden absolute right-0 mt-2 w-96 max-w-[92vw] rounded-xl border border-gray-200 bg-white shadow-xl z-50">
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                @forelse (($headerNotifications ?? collect()) as $notification)
                                    ...
                                    <a href="{{ route('teacher.notifications.open', ['notification' => $notification->id]) }}" class="block px-4 py-3 border-b border-gray-100 hover:bg-gray-50">
...
<script>
    window.addEventListener('DOMContentLoaded', function () {
        ...
        const toggle = document.getElementById('teacherNotificationToggle');
