...
@section('content')
    <div>
        <div class="text-xl font-semibold">Create Enrollment</div>
        <div class="text-sm text-gray-500">Enroll a student into a course</div>
    </div>

    <form method="POST" action="{{ route('admin.enrollments.store') }}" class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
        @csrf
