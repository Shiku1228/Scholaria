...
@section('content')
    <div class="px-6 py-6">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-slate-900">Add Program</h1>
            <p class="text-sm text-slate-500 mt-1">Create a new program under a college.</p>
        </div>

        <form method="POST" action="{{ route('admin.programs.store') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
            @csrf
