...
<<<<<<< HEAD
                                        @elseif($q->isEssay())
                                            <div class="text-sm bg-slate-50 rounded-lg p-3 border border-slate-100">
                                                ...
                                                <div class="text-xs text-violet-600 mt-2">Essay responses require manual review by the instructor.</div>
                                                @if($q->correct_answer)
                                                    <div class="text-xs text-slate-500 mt-2">Reference Answer: {{ $q->correct_answer }}</div>
                                                @endif
                                            </div>
                                        @else
                                            <div class="text-sm bg-slate-50 rounded-lg p-3 border border-slate-100">
