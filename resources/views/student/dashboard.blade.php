...
@section('content')
    <div class="space-y-6">
        <div class="rounded-[28px] p-6 shadow-sm border border-gray-100" style="background: linear-gradient(160deg, var(--slms-panel-grad-a, #0b2d6b) 0%, var(--slms-panel-grad-b, #0a3a8a) 45%, var(--slms-panel-grad-c, #4f46e5) 100%);">
