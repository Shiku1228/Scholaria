                        ...
                        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                            ...
                            <div class="divide-y divide-slate-100">
                                @foreach($assignments as $assignment)
                                    ...
                                    <a href="{{ route('student.assignments.show', (int) $assignment->assignment_id) }}" class="group flex items-center gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 sticky top-6">
                ...
                <div class="p-3 space-y-2 max-h-[400px] overflow-y-auto">
                    @forelse ($assignments->take(5) as $assignment)
                        @php $done = !empty($assignment->submission_id); @endphp
                        <a href="{{ route('student.assignments.show', (int) $assignment->assignment_id) }}" class="block rounded-xl border {{ $done ? 'border-emerald-200 bg-emerald-50/40' : 'border-slate-200 bg-white' }} px-3 py-2 hover:border-[#4f46e5]">
