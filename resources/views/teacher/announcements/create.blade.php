...
@section('content')
    <div class="flex items-start justify-between gap-4">
        <div>
            <div class="text-xl font-semibold">Create Announcement</div>
    ...
    <form method="POST" action="{{ route('teacher.announcements.store', $course) }}" class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
        @csrf
